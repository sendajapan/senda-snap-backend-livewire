    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex items-start justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <!-- View Button -->
                <button @click="openPreview({{ $user->id }})" type="button" class="group relative flex items-center justify-center rounded-lg border-2 border-blue-700/60 bg-blue-500/10 p-2 transition-shadow duration-200 hover:border-blue-700 hover:bg-blue-500/20 hover:shadow-lg hover:shadow-blue-700/30" title="{{ __('View User') }}">
                ...
                <!-- Edit Button -->
                <button @click="openModal({{ $user->id }})" type="button" class="group relative flex items-center justify-center rounded-lg border-2 border-cyan-700/60 bg-cyan-500/10 p-2 transition-shadow duration-200 hover:border-cyan-700 hover:bg-cyan-500/20 hover:shadow-lg hover:shadow-cyan-700/30" title="{{ __('Edit User') }}">
                ...
                <!-- Delete Button -->
                @if($canDelete)
                    <button @click="window.confirmDelete({{ $user->id }}, '{{ addslashes($user->name) }}', []).then((result) => { if (result.isConfirmed) { $wire.$dispatch('delete-user', { userId: {{ $user->id }} }) } })" type="button" class="group relative flex items-center justify-center rounded-lg border-2 border-red-700/60 bg-red-500/10 p-2 transition-shadow duration-200 hover:border-red-700 hover:bg-red-500/20 hover:shadow-lg hover:shadow-red-700/30" title="{{ __('Delete User') }}">
