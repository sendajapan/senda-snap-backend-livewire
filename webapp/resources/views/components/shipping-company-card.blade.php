...
<div class="group relative overflow-hidden {{ $rounded ? 'rounded-xl' : '' }} border border-indigo-200 bg-white/50 p-4 transition-shadow hover:border-indigo-300 hover:shadow-lg dark:border-indigo-900/50 dark:bg-gray-800/50 dark:hover:border-indigo-800">
    <div class="flex flex-col gap-4">
        ...
        <div class="flex items-center justify-end border-t border-gray-200/50 pt-3 dark:border-gray-700/50">
            <div class="flex items-center gap-1.5">
                ...
                <!-- View Button -->
                <button @click="openPreview({{ $shippingCompany->id }})" type="button" class="group relative flex items-center justify-center rounded-lg border-2 border-indigo-700/60 bg-indigo-500/10 p-2 transition-shadow hover:border-indigo-700 hover:bg-indigo-500/20 hover:shadow-lg hover:shadow-indigo-700/30 opacity-50 transition-opacity group-hover:opacity-100" title="{{ __('View Shipping Company') }}">
                ...
                <!-- Edit Button -->
                <button @click="openModal({{ $shippingCompany->id }})" type="button" class="group relative flex items-center justify-center rounded-lg border-2 border-cyan-700/60 bg-cyan-500/10 p-2 transition-shadow hover:border-cyan-700 hover:bg-cyan-500/20 hover:shadow-lg hover:shadow-cyan-700/30 opacity-50 transition-opacity group-hover:opacity-100" title="{{ __('Edit Shipping Company') }}">
