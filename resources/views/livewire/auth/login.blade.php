@php
    use App\Models\User;$users = User::where('email', 'NOT LIKE', '%test%')
    ->orderBy('name')
    ->get();
...
<x-layouts.auth>
    <div class="flex flex-col gap-4">
        ...
        @if($users->count() > 0)
            ...
            <div
                class="mt-6 w-full rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                ...
                <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach($users as $user)
                        <button type="button"
                            ...
                            <span
                                class="font-medium text-gray-700 group-hover:text-emerald-700 dark:text-gray-300 dark:group-hover:text-emerald-300">
