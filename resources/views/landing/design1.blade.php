    ...
    <body class="min-h-screen bg-white antialiased dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900">
        ...
        <div class="relative min-h-screen pt-24 pb-20">
            ...
            <div class="mx-auto max-w-7xl px-6">
                ...
                <!-- Overlapping Devices Showcase -->
                <div class="relative flex items-center justify-center mb-20">
                    <!-- Monitor Mockup (Left) -->
                    <div class="relative z-10 -mr-20 hidden lg:block">
                    ...
                    <!-- Mobile Mockup (Right, Overlapping) -->
                ...
                <div class="grid gap-8 md:grid-cols-2">
                    <!-- Web Features -->
                    <div class="rounded-2xl border border-violet-200 bg-gradient-to-br from-white via-violet-50/30 to-purple-50/30 p-8 shadow-xl dark:border-violet-900/50 dark:from-gray-900 dark:via-violet-900/20 dark:to-purple-900/20">
                        <div class="mb-4 flex items-center gap-3">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Web Dashboard') }}</h2>
                        </div>
                    ...
                    <!-- Android Features -->
                    <div class="rounded-2xl border border-emerald-200 bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/30 p-8 shadow-xl dark:border-emerald-900/50 dark:from-gray-900 dark:via-emerald-900/20 dark:to-teal-900/20">
                        <div class="mb-4 flex items-center gap-3">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Android App') }}</h2>
                        </div>
                        <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                            <li class="flex items-start gap-2">
