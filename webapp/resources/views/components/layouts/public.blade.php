    ...
    <body class="min-h-screen bg-white antialiased dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900">
        ...
        <div class="bg-background flex min-h-svh flex-col gap-4 p-6 md:p-10 relative">
            ...
            <div class="flex items-center">
                <a href="{{ route($backRoute ?? 'home') }}" class="flex items-center gap-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition-colors" wire:navigate>
