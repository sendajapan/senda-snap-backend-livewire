...
<tr class="group transition-all duration-200 hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-purple-50/50 dark:hover:from-indigo-900/10 dark:hover:to-purple-900/10">
            ...
            <div class="ml-2 md:ml-4">
                ...
                @if($shippingCompany->company_name_jp)
                    <div class="text-[10px] md:text-xs text-gray-500 dark:text-gray-400">
                        {{ $shippingCompany->company_name_jp }}
                    </div>
                @endif
            </div>
        </div>
    ...
    <td class="whitespace-nowrap px-3 md:px-6 py-3 md:py-5">
        <flux:badge color="indigo" size="sm" class="font-semibold text-xs">
            {{ $shippingCompany->company_type }}
        </flux:badge>
    </td>
    <td class="whitespace-nowrap px-3 md:px-6 py-3 md:py-5">
        <flux:badge :color="$shippingCompany->company_status === 'Active' ? 'green' : 'gray'" size="sm" class="font-semibold text-xs">
    ...
    <td class="whitespace-nowrap px-3 md:px-6 py-3 md:py-5 hidden lg:table-cell">
        <div class="flex items-center gap-1.5 md:gap-2">
            ...
            <span class="text-xs md:text-sm text-gray-900 dark:text-white truncate max-w-[200px] md:max-w-none">
